...
class AccessKotlinFilesAction : AnAction("Analyze the kt file's Sentiment") {
                        ...
                        VfsUtil.iterateChildrenRecursively(root, null) { virtualFile ->
                            if (virtualFile.extension == "kt") {
                                ...
                                if (psiFile != null) {
                                    ...
                                    val currentFileStats = fileStatisticsMap.getOrPut(fileName) { FileStatistics(fileName) }
                                    ...
                                    comments.forEach { comment ->
                                        ...
                                        pluginScope.launch {
                                            ...
                                            val finalIds = createORTData("input", OnnxTensor.createTensor(env, newInputIds))
